...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, the favorite equals that', () => {
    const result = listHelper.favoriteBlog(oneBlog)
    assert.deepStrictEqual(result, oneBlog[0])
  })

  test('when list has multiple blogs, returns the correct favorite', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, the most blogs equals that', () => {
    const result = listHelper.mostBlogs(oneBlog)
    const correct = { author: "Michael Chan", blogs: 1}
    assert.deepStrictEqual(result, correct)
  })
...
describe('most likes', () => {
  ...
  test('when list has only one blog, the most likes equals that', () => {
    const result = listHelper.mostLikes(oneBlog)
    const correct = { author: "Michael Chan", likes: 7}
    assert.deepStrictEqual(result, correct)
  })
